...
public class ReviewDetail extends Activity {
   ...
   protected void onResume() {
      ...
      Log.v(Constants.LOGTAG, " " + ReviewDetail.CLASSTAG + " imageLink - " + imageLink);
      // tell handler to load image (and use separate Thread to get it, in newer Android SDKs should use AsyncTask)
      new Thread() {
         public void run() {            
