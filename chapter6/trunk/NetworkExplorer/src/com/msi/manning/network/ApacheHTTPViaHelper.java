...
public class ApacheHTTPViaHelper extends Activity {
    ...
    private final Handler handler = new Handler() {
        ...
        public void handleMessage(final Message msg) {
            ...
            ApacheHTTPViaHelper.this.output.setText(bundleResult);
        }
    };
    ...
    public void onCreate(final Bundle icicle) {
        ...
        this.button.setOnClickListener(new OnClickListener() {
            public void onClick(final View v) {
                ...
                ApacheHTTPViaHelper.this.performRequest(ApacheHTTPViaHelper.this.urlChooser.getSelectedItem().toString());                
            }
        });
    };
