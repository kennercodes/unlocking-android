    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        this.button.setOnClickListener(new OnClickListener() {
            public void onClick(final View v) {
                GeocodeExample.this.output.setText(GeocodeExample.this.performGeocode(GeocodeExample.this.input
                        .getText().toString(), GeocodeExample.this.isAddress.isChecked()));
            }
        });
    }
