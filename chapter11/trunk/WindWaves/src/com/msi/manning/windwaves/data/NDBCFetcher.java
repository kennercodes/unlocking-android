...
public class NDBCFetcher {
   ...
   /**
    * Network data fetcher for NDBC RSS feeds, 
    * requires lat in such as 37W, and long in such as 122E (not integers or doubles, Strings).
    * 
    * @param lat
    * @param lon
    * @param rad
    */
    public NDBCFetcher(String lat, String lon, String rad) {
        ...
        this.query = QBASE + QLAT + this.lat + QLON + this.lon + QRAD + this.rad;
        Log.i(Constants.LOGTAG, CLASSTAG + " query - " + this.query);        
    }
