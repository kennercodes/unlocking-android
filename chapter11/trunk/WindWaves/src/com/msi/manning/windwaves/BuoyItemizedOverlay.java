...
/**
 * Map Overlay class that extends ItemizedOverlay - puts the same marker on the
 * map for each OverlayItem, and handles tap events, etc.
 * 
        ...
        new AlertDialog.Builder(this.context) 
            ...
            .setPositiveButton("More Detail", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface di, int what) {
                    ...
                    // (not really ideal, but don't need a Parcelable here either, and don't want to pass in Bundle separately, etc)
